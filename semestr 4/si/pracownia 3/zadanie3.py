...
def block(a, b):                                                                                #NEW
    return [V(a + i, b + j) for i in range(3) for j in range(3)]                                #NEW

def blocks():                                                                                   #NEW                   
    return [all_different(block(i, j)) for i in range(0, 7, 3) for j in range(0, 7, 3)]         #NEW
...
def sudoku(assigments):
    ...
    cs = domains(variables) + vertical() + horizontal() + blocks()                              #CHANGE
