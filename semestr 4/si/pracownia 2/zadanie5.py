'''
Rozwiązanie korzysta z algorytmu A* - heurystyka jest równa największej minimalnej odległości do jakiegoś celu pośród wszystkich
rozważanych potenchalnych pozycji.
'''
...
def priority(state):
    return max(distances[position] for position in state.positions) + len(state.movs)
